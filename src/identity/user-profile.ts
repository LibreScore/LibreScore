 ...
 */
export const resolveUserProfile = async function* (pubKey: PubKeyType, ipfs: IPFS): AsyncGenerator<UserProfile> {
  const PublicKey = await import('./pubkey') // code splitting
